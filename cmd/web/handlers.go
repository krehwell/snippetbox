...
import (
	...
	"snippetbox.krehwell.com/internal/validator"
)
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	redirectPath := app.sessionManager.PopString(r.Context(), "redirectPathOnLogin")
	if redirectPath != "" {
...
func (app *application) updatePasswordPost(w http.ResponseWriter, r *http.Request) {
	...
	err = app.users.UpdatePassword(currUserId, form.CurrentPassword, form.NewPassword)
	if err != nil {
		if errors.Is(err, models.ErrInvalidCredentials) {
